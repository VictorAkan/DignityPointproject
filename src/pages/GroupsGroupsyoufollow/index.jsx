...
const GroupsGroupsyoufollowPage = () => {
      ...
      <div className="bg-white-A700_01 flex flex-col font-poppins items-center justify-start mx-auto w-full">
        <div className="flex flex-col gap-[9px] items-center justify-start w-full">
          ...
          <div className="flex md:flex-col flex-row gap-3 items-center justify-start max-w-[1412px] mx-auto md:px-5 w-full">
            ...
            <div className="bg-white-A700 flex md:flex-1 flex-col items-center justify-start p-[15px] rounded-[20px] w-[77%] md:w-full">
              <div className="flex flex-col gap-2.5 items-start justify-start mb-[93px] w-auto md:w-full">
                <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between max-w-[1040px] w-full">
                  ...
                  <div className="flex md:flex-1 md:flex-col flex-row gap-5 items-start justify-start w-auto md:w-full">
                    <div className="flex flex-row gap-2.5 items-center justify-start w-auto">
                      <Button
                        className="bg-transparent cursor-pointer flex items-center justify-center min-w-[113px]"
                        leftIcon={
                ...
                <div className="gap-2.5 md:gap-5 grid sm:grid-cols-1 md:grid-cols-2 grid-cols-4 justify-center min-h-[auto] w-full">
                  <div className="flex flex-1 flex-col gap-2.5 items-start justify-start w-full">
                    <div
                      className="bg-cover bg-no-repeat bg-white-A700 flex flex-col h-[150px] items-center justify-start pt-[92px] rounded-lg w-full"
                      style={{
                        backgroundImage:
                          "url('images/img_frame8771_22x252.png')",
                      }}
                    >
                      <div className="bg-gradient1  flex flex-col items-center justify-end p-[15px] rounded-bl-lg rounded-br-lg w-full">
                        <Text
                          className="mt-[3px] text-base text-center text-white-A700"
                      ...
                      <div className="flex relative w-[110px]">
                        <div className="flex my-auto w-[78%]">
                          <div className="flex my-auto w-[71%]">
                            <Img
                              className="h-[35px] my-auto rounded-[50%] w-[35px]"
                              src="images/img_hannah_1x35.png"
                              alt="hannah"
                            />
                            <Img
                              className="h-[35px] ml-[-10px] my-auto rounded-[50%] w-[35px] z-[1]"
                    ...
                    <Text
                      className="max-w-[252px] md:max-w-full text-[13px] text-gray-700"
                      size="txtPoppinsMedium13"
                    >
                    ...
                    <Button
                      ...
                      leftIcon={
                        <div className="mt-0.5 mb-1.5 mr-[5px] bg-black-900_01">
                  ...
                  <div className="flex flex-1 flex-col gap-2.5 items-start justify-start w-full">
                    <div className="h-[150px] relative w-full">
                      <Img
                        className="h-[150px] m-auto object-cover rounded-lg w-full"
                        src="images/img_image25_22x252.png"
                        alt="imageTwentyFive"
                      />
                      <Button
                        className="absolute bottom-[0] cursor-pointer font-semibold inset-x-[0] leading-[normal] min-w-[252px] mx-auto rounded-bl-lg rounded-br-lg text-base text-center"
                        size="lg"
                        variant="gradient"
                        color="black_900_00_black_900_66"
                      >
                        Historical Images
                      </Button>
                    </div>
                  ...
                  <div className="flex flex-1 flex-col gap-2.5 items-start justify-start w-full">
                    <div className="h-[150px] relative w-full">
                      <Img
                        className="h-[150px] m-auto object-cover rounded-lg w-full"
                        src="images/img_jakeprofilepic_150x252.png"
                        alt="jakeprofilepic"
                      />
                      <Button
                        className="absolute bottom-[0] cursor-pointer font-semibold inset-x-[0] leading-[normal] min-w-[252px] mx-auto rounded-bl-lg rounded-br-lg text-base text-center"
                  ...
                  <div className="flex flex-1 flex-col gap-2.5 items-start justify-start w-full">
                    <div className="h-[150px] relative w-full">
                      <Img
                        className="absolute h-[150px] inset-[0] justify-center m-auto object-cover rounded-lg w-full"
                        src="images/img_image26_150x252.png"
                        alt="imageTwentySix"
                      />
                      <Button
                        className="absolute bottom-[0] cursor-pointer font-semibold inset-x-[0] leading-[normal] min-w-[253px] mx-auto rounded-bl-lg rounded-br-lg text-base text-center"
                        size="lg"
                        variant="gradient"
                        color="black_900_00_black_900_66"
                      >
...
export default GroupsGroupsyoufollowPage;
