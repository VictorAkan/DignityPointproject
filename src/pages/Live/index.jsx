    ...
    <>
      <div className="bg-white-A700_01 flex flex-col font-poppins gap-8 items-center justify-start mx-auto w-full">
        ...
        <div className="bg-white-A700 flex flex-col items-start justify-end max-w-[1259px] mx-auto pt-[19px] md:px-5 px-[19px] rounded-[20px] shadow-bs4 w-full">
          ...
          <div className="flex md:flex-col flex-row gap-12 items-center justify-center md:ml-[0] ml-[9px] mt-2.5 w-auto md:w-full">
            ...
            <div className="flex flex-col gap-1 items-center justify-center w-auto">
              ...
              <div className="bg-green-700 h-1.5 w-[55%]"></div>
            </div>
            ...
            <div className="flex flex-col items-center justify-start mb-[15px] w-[98%] md:w-full">
              <div className="flex flex-col items-start justify-start w-full">
                <div className="h-[74px] relative w-full">
                  <div className="absolute bg-white-A700 h-16 inset-x-[0] mx-auto rounded-[12px] top-[0] w-full"></div>
                  <div className="absolute flex flex-row gap-[13px] h-full inset-y-[0] items-start justify-between left-[0] my-auto w-[24%]">
                    <div className="md:h-16 h-[74px] relative w-1/4">
                      <Img
                        className="common-pointer absolute h-16 inset-x-[0] mx-auto rounded-[50%] top-[0] w-16"
                        src="images/img_hannah_2.png"
                        alt="hannah"
                        onClick={() => navigate("/homeviewprofile")}
                      />
                      <Text
                        className="absolute bg-red-A700_01 bottom-[0] h-[21px] inset-x-[0] justify-center mx-auto px-2 text-white-A700 text-xs w-max"
                  ...
                  <div className="absolute flex flex-row gap-[12.86px] items-center justify-between right-[0] top-[22%] w-[74px]">
                    <Img
                ...
                <Text
                  className="mt-[5px] sm:text-[16.57px] md:text-[18.57px] text-[20.57px] text-gray-900"
                  size="txtPoppinsSemiBold2057"
                >
                  Looking to make friends, give me a follow
                </Text>
                <div className="bg-white-A700 h-[461px] sm:h-[471px] md:h-[951px] mt-2.5 relative w-full">
                    ...
                    <div className="h-[461px] md:h-[941px] m-auto w-full">
                      <div className="flex md:flex-col flex-row md:gap-5 h-full items-center justify-evenly m-auto w-full">
                        <div className="h-[461px] relative w-[74%] md:w-full">
                          <div className="absolute bg-lime-50 flex flex-row gap-[11px] h-full inset-y-[0] items-start justify-center left-[0] my-auto p-[5px] w-[38%]">
                            <Text
                              className="ml-[108px] mt-[421px] text-blue_gray-900 text-xl"
                              size="txtPoppinsMedium20Bluegray900"
                            >
                              1.06/16.00
                            </Text>
                            <Img
                              className="h-6 mr-16 mt-[422px]"
                ...
                <div className="flex sm:flex-col flex-row md:gap-10 items-center justify-between mt-3 w-full">
                  <div className="flex flex-row gap-[12.86px] items-center justify-start w-auto">
