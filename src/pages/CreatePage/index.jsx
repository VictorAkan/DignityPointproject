              ...
              <div className="flex flex-col gap-5 items-start justify-start mb-[195px] w-auto">
                <div className="flex flex-col gap-[5px] items-start justify-start w-auto">
                  ...
                  <Text
                    ...
                    size="txtPoppinsMedium13"
                  >
                    Pages contains all the tools needed to start and promote
                    your business on Malipoma
                  </Text>
                </div>
                <Text
                  className="text-base text-black-900_01 w-auto"
                ...
                <div className="flex flex-col gap-[5px] items-start justify-start w-auto">
                  ...
                  <TextArea
                    className="bg-indigo-50 border-0 font-medium gap-2.5 leading-[normal] pb-20 pt-2.5 px-2.5 rounded-lg text-[13px] placeholder:text-gray-500_01 text-gray-500_01 text-left w-auto"
                    name="frame8754_One"
                ...
                <Button
                  ...
                  onClick={() => navigate("/createpagethree")}
