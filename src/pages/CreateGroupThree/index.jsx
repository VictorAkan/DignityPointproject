...
const CreateGroupThreePage = () => {
  const navigate = useNavigate();

  return (
    <>
      <div className="bg-white-A700_01 flex flex-col font-poppins items-center justify-end mx-auto pt-[50px] md:px-10 sm:px-5 px-[50px] w-full">
        <div className="flex md:flex-col flex-row gap-2.5 items-start justify-start max-w-[1412px] mt-3 mx-auto w-full">
          <div className="bg-white-A700 flex md:flex-1 flex-col items-center justify-start mb-[89px] md:mt-0 mt-0.5 p-2.5 w-[23%] md:w-full">
            <div className="flex flex-col gap-5 items-start justify-start mb-[133px] w-auto">
              ...
              <Button
                ...
                onClick={() => navigate("/creategroupfour")}
...
export default CreateGroupThreePage;
