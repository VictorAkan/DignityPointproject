  ...
  return (
    ...
    >
      <div className="max-h-[97vh] overflow-y-auto sm:w-full md:w-full">
        <div className="bg-white-A700_01 flex flex-col items-center justify-start max-w-[1192px] mx-auto my-4 p-[23px] md:px-5 rounded-[20px] w-full">
          <div className="flex flex-col gap-3 items-end justify-start mb-[9px] w-[99%] md:w-full">
            <div className="flex flex-row sm:gap-10 items-center justify-between w-[61%] md:w-full">
              <Text
                  ...
                  <div className="flex sm:flex-col flex-row gap-2 items-start justify-start mt-4 w-auto sm:w-full">
                    ...
                    <div className="flex sm:flex-col flex-row sm:gap-5 items-start justify-start w-[91%] sm:w-full">
                      ...
                      <div className="bg-white-A700 flex flex-col p-0.5 relative rounded-[20px] shadow-bs4 w-[98%] sm:w-full">
                        ...
                        <div className="flex flex-row gap-4 items-center justify-between ml-auto mr-[13px] mt-[-12px] w-auto z-[1]">
